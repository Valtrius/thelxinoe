...
`frontend/public/tmdb.svg` is the unchanged approved primary short TMDB logo, downloaded from [TMDB's official logo assets](https://www.themoviedb.org/assets/v4/logos/v2/blue_short-8e7b30f73a4020692ccca9c88bafe5dcb6f8a62a4c6bc55cd9ba82bb2cd95f6c.svg). It is used according to [TMDB's attribution requirements](https://developer.themoviedb.org/docs/faq).
